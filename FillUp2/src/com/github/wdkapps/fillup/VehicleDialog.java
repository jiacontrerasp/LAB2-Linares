...
public class VehicleDialog {
	...
	/**
	 * DESCRIPTION:
	 * Validates the vehicle brand string.
	 * @param brand - the vehicle brand String to validate.
	 * @return boolean - true = valid.
	 */
	 ...
	 * DESCRIPTION:
	 * Validates the vehicle brand string.
	 * @param plate - the vehicle brand String to validate.
	 * @return boolean - true = valid.
	 */
	 ...
	 * DESCRIPTION:
	 * Validates the vehicle brand string.
	 * @param type - the vehicle brand String to validate.
	 * @return boolean - true = valid.
	 */
